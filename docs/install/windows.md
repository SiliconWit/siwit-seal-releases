...
If you'd like to verify you've got the right file, compare its SHA-256 against the checksum published on the [Releases page](https://github.com/SiliconWit/siwit-seal-releases/releases) (see [Verifying downloads](index.md#verifying-downloads)).
